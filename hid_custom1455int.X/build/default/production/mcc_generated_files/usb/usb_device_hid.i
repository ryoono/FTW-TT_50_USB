# 1 "mcc_generated_files/usb/usb_device_hid.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "mcc_generated_files/usb/usb_device_hid.c" 2
# 44 "mcc_generated_files/usb/usb_device_hid.c"
...
# 44 "mcc_generated_files/usb/usb_device_hid.c" 2
...
# 45 "mcc_generated_files/usb/usb_device_hid.c" 2
# 67 "mcc_generated_files/usb/usb_device_hid.c"
typedef struct
{
    unsigned :8;
    unsigned :8;
...
# 161 "mcc_generated_files/usb/usb_device_hid.c"
void USBCheckHIDRequest(void)
{
    ...
    if(SetupPkt.bRequest == 6)
    {
        switch(SetupPkt.bDescriptorType)
        {
            ...
            case 0x22:
                ...
                break;
            case 0x23:
# 205 "mcc_generated_files/usb/usb_device_hid.c"
                break;
        }
    }
